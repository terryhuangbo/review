...
<div class="fullwidth row container-main article-wrapper">
    ...
    <div class="main js-scrollto-stop" cmpt-article-contents data-post-id="<?php the_ID() ?>"><!-- begin main -->
        ...
        <div class="post-item-container">
            ...
            <div class="post-item-content full-image">
                <img src="http://images.ifanr.cn/wp-content/uploads/2016/03/writing.jpg" alt="深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？"/>
            </div>
            <div style="display:none"><img src="http://images.ifanr.cn/wp-content/uploads/2016/03/writing.jpg!baidutthumbnail" alt="hello, baidu spider =.="/></div>
        </div>
        ...
        <div id="article-wrapper" class="post-item-container row" data-cmpt-autofixed-container>
            ...
            <div class="post-item-content">
                <!-- start of article -->
                <article itemscope itemtype="http://schema.org/Article" id="post-<? the_ID() ?>" class="clearfix js-article-wrapper">
                    <div class="entry-header">
                        <a class="tag-label-cate" href="<?php echo get_the_tag_link($cat->term_id) ?>"><i class="ifanr2015 ifanr2015-chanpin01 icon-book"></i><?php echo $cat->name ?></a>
                        <h1 itemprop="headline" class="entry-name"><?php the_title() ?></h1>
                        <div class="tag-label">
                            <a href="http://www.ifanr.com/author/huangmeijing" title="Posts by <?php the_author() ?>" rel="author"><?php the_author() ?></a><span class="seperator">|</span>
                            <span itemprop="datePublished" datetime="2016-03-04T09:57:36+0000"><?php echo $Tool->_get_diff_date(strtotime(get_the_time('Y-m-d H:i:s'))) ?></span>
                            <meta itemprop="author" content="<?php the_author() ?>" />
                            <meta itemprop="thumbnailUrl" content="http://images.ifanr.cn/wp-content/uploads/2016/03/writing.jpg" />
                        </div>
                    </div>
                ...
                <div class="ifr-article-component row">
                    <div class="likes-and-comments">
                        <a href="javascript:void(0)" id="article-likes" class="footer-item js-ifanr-like" data-id="628698">
                    ...
                    <div id="sns-buttons" class="row sns-share sns-tools js-sns-tools">
                        <span class="sns-items-wrapper js-ifanr-shares-wrapper">
                            ...
                            <a href="http://v.t.sina.com.cn/share/share.php?url=http://www.ifanr.com/628698&title=深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？" data-share="sina" rel="nofollow" class="js-share-buttons ifanr-share-buttons weibo" id="sina-share" title="分享到新浪微博" target="_blank"><i class="ifanr2015 ifanr2015-xinlangweibo"></i></a>
                            <a href="javascript:void(0)" data-post-url="http://www.ifanr.com/628698" data-el="share-to-wechat" data-placement="top" data-toggle="popover" rel="nofollow" class="js-share-buttons ifanr-share-buttons weixin" id="wechat-share" title="分享到微信朋友圈"><i class="ifanr2015 ifanr2015-weixin"></i></a>
                            <a class="sns-item ifanr-share-buttons twitter" rel="nofollow" data-share="twitter" target="_blank" href="https://twitter.com/intent/tweet?button_hashtag=ifanr&text=深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？&url=http://www.ifanr.com/628698"><i class="ifanr2015 ifanr2015-twitter"></i></a>
                            <a class="sns-item ifanr-share-buttons linkedin" rel="nofollow" data-share="linkedin" target="_blank" href="https://www.linkedin.com/shareArticle?title=深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？&url=http%3A%2F%2Fwww.ifanr.com%2F628698&summary=
                                早在很久以前，有人告诉我：鱼的记忆只有 7 秒，7 秒之后它就不会记得曾经的事情了，所有的一切又都会变成崭新的开始。
                                而在这个打开微信就有几十个公众号更新、各种新闻客户端轮番推送轰炸、人人都是自...&source=ifanr" ga-track="event" ga-event-category="button" ga-event-label="linkedin_share"><i class="ifanr2015 ifanr2015-linkedin"></i></a>
                            <a id="J_SendCWB" href="http://www.ifanr.com/api/special/changweibo/index.php?ifr_post_id=628698" rel="nofollow" class="ifanr-share-buttons js-share-buttons btn-long-weibo">发送长微博</a>
                            <div class="sns-item more js-share-items-more" href="javascript:void(0);">
                                <i class="ifanr2015 ifanr2015-more"></i>
                                <a rel="nofollow" class="sns-item ifanr-share-buttons evernote" data-share="evernote" target="_blank" href="http://www.evernote.com/clip.action?url=http://www.ifanr.com/628698&title=深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？"><i class="ifanr2015 ifanr2015-evernote"></i></a>
                                <a rel="nofollow" class="sns-item ifanr-share-buttons douban" data-share="douban" target="_blank" href="http://www.douban.com/share/service?href=http://www.ifanr.com/628698&name=深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？"><i class="ifanr2015 ifanr2015-douban"></i></a>
                                <a rel="nofollow" class="sns-item ifanr-share-buttons qqzone" data-share="qqzone" target="_blank" href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=http://www.ifanr.com/628698&title=深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？"><i class="ifanr2015 ifanr2015-qqkongjian"></i></a>
                            </div>
                        </span>
                    </div>
                    ...
                    <div class="author-profile-wrapper">
                        <div class="author-profile row">
                            <div class="author-profile-face">
                                <img class="gravatar" src="http://images.ifanr.cn/wp-content/uploads/2015/11/huangmeijing_meitu_1.jpg" width="50" height="50" />
                            </div>
                            <div class="author-profile-info-wrapper">
                                <div class="author-profile-text">
                                    <h2 class="js-post-author-name"><a href="http://www.ifanr.com/author/huangmeijing"><?php the_author() ?></a></h2>
                                    <span class="seperator">|</span><p class="job">编辑</p>
                                    <span class="homepage"><a href="http://www.ifanr.com/author/huangmeijing">作者主页</a></span>
                                </div>
    ...
    <div id="sbl" data-cmpt-autofixed-container class="sbl js-single-post-sidebar">
        ...
        <div data-cmpt-autofixed data-autofixed-follow-to=".js-article-wrapper">
            <div id="author-latest-posts" data-author-id="2875" data-author-link="http://www.ifanr.com/author/huangmeijing" class="widget-ifr ifr-post-list-widget author-latest-posts widget-container clearfix"></div>
    ...
    <div class="fullwidth">
        ...
        <div id="comments" class="comments-wrapper" data-cmpt-autofixed-container cmpt-article-footer data-post-id="628698">
            ...
            <div data-cmpt-autofixed data-autofixed-follow-to="#comments-box" id="comments-head" class="J_CmtHead post-item-container">
                ...
                <p class="post-title">
                    深度的文章、优雅的讨论、赚钱的作者，这些是 Medium 的妄想还是未来？    </p>
